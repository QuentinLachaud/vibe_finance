...
function drawBrandHeader(doc: jsPDF, pw: number, margin: number, subtitle: string, extra?: string): void {
  ...
  doc.text('TakeHomeCalc', margin, 16);
...
export function exportTakeHomePdf(
  ...
  // ── Footer ──
  drawFooter(doc, pw, 'Generated by TakeHomeCalc  ·  Estimates based on UK HMRC 2025-26 rates  ·  Not financial advice');
...
export function exportSavingsCalcPdf(
  ...
  // ── Footer ──
  drawFooter(doc, pw, 'Generated by TakeHomeCalc  ·  Not financial advice');
